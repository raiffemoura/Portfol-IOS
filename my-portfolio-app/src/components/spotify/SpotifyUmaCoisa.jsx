...
import album from '../../assets/spotify-images/uma-coisa.jpeg'
            ...
            <div>
                ...
                <div className='audio-container'>
                    <audio ref={audioPlayer} >
                        <source src={umacoisa} type="audio/mp3" />
                        <source src={umacoisaOGG} type="audio/ogg" />
                    ...
                    <div className='audio-buttons'>
                        ...
                        <button
                            ...
                            {isPreviusMouseOver ? (
                            <Link to={"/spotify/Peregrino"}><img onClick={stop} className='previus' src={previusWhite} alt="previusWhite" /></Link>
                            ) : (
                        ...
                        <button
                            ...
                            {isNextMouseOver ? (
                            <Link to={"/spotify/Peregrino"}><img onClick={stop} className='next' src={nextWhite} alt="nextWhite" /></Link>
                            ) : (
