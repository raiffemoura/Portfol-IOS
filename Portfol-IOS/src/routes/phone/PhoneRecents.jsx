                ...
                <div className="screen">
                    ...
                    <div className='menu-bottom-phone'>
                        ...
                        <Link to={"/phone/favourites"}>
                            <div>
                                <img className='menu-bottom-phone-img' src={iconConfig.favourites} alt="favourites"   />
                                <p>Favourites</p>
                            </div>
                        </Link>
                        <Link to={"/phone/recents"}>
                            <div>
                                <img className='menu-bottom-phone-img' src={iconConfig.recentsBlue} alt="recents"   />
                                <p>Recents</p>
                            </div>
                        </Link>
                        ...
                        <div>
                            <img className='menu-bottom-phone-img' src={iconConfig.voicemail} alt="voicemail"   />
                            <p>Voicemail</p>
                        </div>
                    </Link>
                    </div>
