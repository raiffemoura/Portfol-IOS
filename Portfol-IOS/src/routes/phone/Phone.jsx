                ...
                <div className="screen">
                    ...
                    <div className="keypad">
                        ...
                        <button  className='keypad-erase'>
                            <img src={isEraseHovered ? EraseHover : Erase} alt="erase" onClick={erase} onMouseEnter={() => setIsEraseHovered(true)} onMouseLeave={() => setIsEraseHovered(false)} />
                        </button>                        
                    ...
                    <div className='menu-bottom-phone'>
                        ...
                        <Link to={"/phone/favourites"}>
                            <div>
                                <img className='menu-bottom-phone-img' src={favourites} alt=""   />
                                <p>Favourites</p>
                            </div>
                        </Link>
                        ...
                        <Link to={"/phone/contacts"}>
                            ...
                            <Link to={"/phone"}> 
                        <div>
                            <img className='menu-bottom-phone-img' src={keypadBlue} alt=""   />
                            <p>Keypad</p>
                        </div>
                    </Link>
